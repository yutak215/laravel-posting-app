<!DOCTYPE html>
 ...
 <body>
    ...
    <div class="container">
        ...
        <!-- storeメソッドで設定した、リダイレクト時にフラッシュメッセージも添付のやつ -->
        <!-- セッションに保存されるのでセッションのへルパ関数で呼び出す -->
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            ...
                            <!-- form要素にonsubmit属性を設定し、JavaScriptのconfirm()メソッドを使って確認ダイアログを表示 -->
                            <!-- HTMLフォームはGETやPOSTしか直接指定できませんが、Laravelは methodを使って擬似的にDELETEメソッドを指定できる -->
